...
const CommitReveal = ({ props }) => {
    ...
    if (commitStatus) {
        return (
            <Commit connectWallet={connectWallet} id={id} setCommitStatus={setCommitStatus} setRevealStatus={setRevealStatus}/>
        );
    }

    if (revealStatus) {
        return (
            <Reveal connectWallet={connectWallet} id={id} setRevealStatus={setRevealStatus}/>
        );
    }
